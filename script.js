...
function agregarRegistroATabla(registro) {
    ...
    cellVendedor.innerHTML = `<select onchange="actualizarVendedor(this)">
...
function actualizarEstado(input) {
    ...
    if (correo.includes('@')) {
        ...
        fechaVentaCell.textContent =[_{{{CITATION{{{_1{](https://github.com/la9una/web/tree/ba1073ae044ebb7b538a3b13f0f9598f7c410bb6/docs%2Fbootstrap%2Falignci.md)[_{{{CITATION{{{_2{](https://github.com/CLONATORE/markdowns/tree/82cfb03683ceb807a7091de48045e6a7485acd72/webpack.md)